  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main Content */}
        <main className="pt-8 pb-12 px-4 md:px-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="text-center mt-4">
                      ...
                      >
                        Feels like {weatherData?.current?.current?.feelslike_c}
                        °C
                      </div>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="space-y-5">
                  {[
                    ...
                    >
                      <div
                        className={`flex items-center ${item.textColor} mb-2`}
                      >
                        {item.icon}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        >
                          {
                            weatherData?.forecast?.forecast?.forecastday[0]
                              ?.astro?.sunrise
                          }
                        </div>
                      </div>
                    ...
                    <div
                      className={`px-3 py-1 rounded-full text-sm font-semibold ${
                        weatherData?.current?.current?.air_quality?.us_epa <= 50
                          ...
                          : weatherData?.current?.current?.air_quality
                              ?.us_epa <= 100
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      },
                      {
                        name: "PM2.5",
                        value:
                          weatherData?.current?.current?.air_quality?.pm2_5,
                        unit: "μg/m³",
                      },
                      {
                        name: "PM10",
